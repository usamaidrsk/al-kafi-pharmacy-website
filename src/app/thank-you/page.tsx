...
export const metadata: Metadata = {
  title: "Thank You",
  description:
    "Thank you page for Al Kaafi Pharmacy website submissions.",
    ...
    <main className="bg-[#faf5ef] px-5 py-20 md:px-6 md:py-28">
      <section className="mx-auto max-w-3xl rounded-[2rem] border border-[#012e20]/10 bg-white p-8 text-center shadow-[0_24px_70px_rgba(1,46,32,0.08)] md:p-12">
        ...
        <p className="mt-5 text-base leading-8 text-slate-700">
          If you sent an enquiry, the pharmacy team will respond through the
          contact details you provided. If you subscribed to updates, your email
          has been added to the mailing list. This website is not an emergency
